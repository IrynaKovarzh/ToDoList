 ...
 * 
 * Note: should store an object, ArrayList needs generic info so store the list
 * with declaration inside another POJO for loading.
 * 
 * @author Mattias
 */
public class XmlIO {
	...
	/**
	 * Load an object from the contents of an XML file. This function will
	 * automatically match the data to the clazz parameter.
	 * 
	 * @param <T>
	 ...
	 * @param clazz
	 *            a reference to the Class of the type to load.
	 ...
	 * 
	 * @param fileName
	 *            the name to write the object to
	 * @param obj
	 *            the object to write
	 * @throws IOException
	 */
